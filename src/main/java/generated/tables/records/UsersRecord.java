...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record4<String, String, String, Byte> {
    ...
    /**
     * Setter for <code>accountbook_test.users.is_active</code>.
     */
    ...
    /**
     * Getter for <code>accountbook_test.users.is_active</code>.
     */
    ...
    @Override
    public UsersRecord values(String value1, String value2, String value3, Byte value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(String userId, String hashedPassword, String mailAddress, Byte isActive) {
        super(Users.USERS);
