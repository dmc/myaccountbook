...
public class JournalEntriesRecord extends UpdatableRecordImpl<JournalEntriesRecord> implements Record5<String, LocalDate, String, String, String> {
    ...
    @Override
    public Row5<String, LocalDate, String, String, String> valuesRow() {
    ...
    @Override
    public JournalEntriesRecord value5(String value) {
        setUserId(value);
        return this;
    }

    @Override
    public JournalEntriesRecord values(String value1, LocalDate value2, String value3, String value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JournalEntriesRecord(String entryId, LocalDate dealDate, String entryDescription, String fiscalYearmonth, String userId) {
        super(JournalEntries.JOURNAL_ENTRIES);
